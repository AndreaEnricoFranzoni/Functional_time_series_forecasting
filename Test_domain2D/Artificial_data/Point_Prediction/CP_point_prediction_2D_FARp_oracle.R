...
CP_point_prediction_2D_FARp_oracle = function(data_y,
                                             indexes_not_NA=NULL,
                                             l, 
                                             b, 
                                             seed_split=FALSE,
                                             ...
                                             )
{
  ...
  for (i in training){
    predicted_fun_matrix[i,] = as.numeric(basis_eval %*% PSI_1 %*% C[,i-1] +basis_eval %*% PSI_2 %*% C[,i-2])
  } 
  rm(i)
  ...
  predicted_fun_n_plus_1 = as.numeric(basis_eval %*% PSI_1 %*% C[,n] +basis_eval %*% PSI_2 %*% C[,n-1])
