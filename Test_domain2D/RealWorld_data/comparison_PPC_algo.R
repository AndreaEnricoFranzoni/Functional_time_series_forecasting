...
title = paste0("Prediction error, mouth, two differentiations")
zone = "mouth"
agg_dt = "_diff_2"
...
title = paste0("Prediction error, center, one differentiation")
zone = "center"
agg_dt = "_diff_1"
...
title = paste0("Prediction error, center, two differentiations")
zone = "center"
agg_dt = "_diff_2"
