...
#store results
prediction_PPC_mouth          <- lapply(1:days_to_be_pred,function(x) NULL)
prediction_PPC_mouth_diff_1   <- lapply(1:days_to_be_pred,function(x) NULL)
prediction_PPC_mouth_diff_2   <- lapply(1:days_to_be_pred,function(x) NULL)
prediction_PPC_center         <- lapply(1:days_to_be_pred,function(x) NULL)
prediction_PPC_center_diff_1  <- lapply(1:days_to_be_pred,function(x) NULL)
prediction_PPC_center_diff_2  <- lapply(1:days_to_be_pred,function(x) NULL)
...
for (i in 1:days_to_be_pred) {
  ...
  prediction_PPC_mouth[[i]] = list(Prediction = predictor$`One-step ahead prediction`, Alpha = predictor$Alpha, N_PPCs = predictor$`Number of PPCs retained`, Exp_Pow = predictor$`Explanatory power PPCs` )
...
# save results
if(save_res){
  save(prediction_PPC_mouth, file = paste0(path_store_res,"/prediction_PPC_mouth.Rdata"))
}


# diff 1
string_message = "
                  PPC prediction of mouth zone diff 1 "
for (i in 1:days_to_be_pred) {
...
# save results
if(save_res){
  save(prediction_PPC_mouth_diff_1, file = paste0(path_store_res,"/prediction_PPC_mouth_diff_1.Rdata"))
}


# diff 2
string_message = "
                  PPC prediction of mouth zone diff 2 "
for (i in 1:days_to_be_pred) {
...
# save results
if(save_res){
  save(prediction_PPC_mouth_diff_2, file = paste0(path_store_res,"/prediction_PPC_mouth_diff_2.Rdata"))
}
...
for (i in 1:days_to_be_pred) {
  ...
  prediction_PPC_center[[i]] = list(Prediction = predictor$`One-step ahead prediction`, Alpha = predictor$Alpha, N_PPCs = predictor$`Number of PPCs retained`, Exp_Pow = predictor$`Explanatory power PPCs` )
...
# save results
if(save_res){
  save(prediction_PPC_center, file = paste0(path_store_res,"/prediction_PPC_center.Rdata"))
}


# diff 1
string_message = "
                  PPC prediction of center zone diff 1 "
for (i in 1:days_to_be_pred) {
...
# save results
if(save_res){
  save(prediction_PPC_center_diff_1, file = paste0(path_store_res,"/prediction_PPC_center_diff_1.Rdata"))
}


# diff 2
string_message = "
                  PPC prediction of center zone diff 2 "
for (i in 1:days_to_be_pred) {
...
# save results
if(save_res){
  save(prediction_PPC_center_diff_2, file = paste0(path_store_res,"/prediction_PPC_center_diff_2.Rdata"))
}