...
for(i in 1:days_to_be_pred){
  ...
  test_set = Xt_mouth_diff_2[,i + idx_first_day_first_train + window_train_set]
...
for(i in 1:days_to_be_pred){
  ...
  test_set = Xt_center_diff_1[,i + idx_first_day_first_train + window_train_set]
...
for(i in 1:days_to_be_pred){
  ...
  test_set = Xt_center_diff_2[,i + idx_first_day_first_train + window_train_set]
