...
dir_stor_res = "/Test_PPC_robustness/test_non_far1/results/plot_errors"
...
#En
summary(res_PPC_no_far1$En)
mean(res_PPC_no_far1$En)
sd(res_PPC_no_far1$En)


summary(res_EX_no_far1$En)
mean(res_EX_no_far1$En)
sd(res_EX_no_far1$En)
