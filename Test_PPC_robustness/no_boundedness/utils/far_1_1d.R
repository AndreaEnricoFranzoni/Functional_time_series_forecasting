...
feat_far_1_process <- function(kernel_id, norm)
{
  ...
  if(kernel_id=="identity")
  {
    ...
    {
      a    <- 1.02
      name <- "Identity, norm=1.02"
    }
    if(norm==1.025)
    {
      a    <- 1.025
      name <- "Identity, norm = 1.025"
    }
  }
  if(kernel_id=="sp_t")
  {
    ...
    {
      a    <- sqrt(3)*1.025
      name <- "Sloping plane t, norm = 1.025"
    }
    if(norm==1.178)
    {
      a    <- sqrt(3)*1.178
      name <- "Sloping plane t, norm = 1.2"
    }
  }
  if(kernel_id=="sp_s")
  {
    ...
    {
      a    <- sqrt(3)*1.025
      name <- "Sloping plane s, norm = 1.025"
    }
    if(norm==1.178)
    {
      a    <- sqrt(3)*1.178
      name <- "Sloping plane s, norm = 1.2"
    }
  }
