...
dir_stor_res = "/Test_PPC_robustness/test_non_boundness/results/plot_errors"
path_stor_res = paste0(dir_w,dir_stor_res)
dir_stor_res2 = "/Test_PPC_robustness/test_non_boundness/results/error_dynamic_plot"
path_stor_res2= paste0(dir_w,dir_stor_res2)


#where errors are
dir_res = paste0(dir_w,"/Test_PPC_robustness/test_non_boundness/results")
