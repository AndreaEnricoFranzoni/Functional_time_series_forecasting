...
{
  vec_data = c(res_PPC_gau_0_5$Prediction,
               res_PPC_gau_0_8$Prediction,
               res_PPC_id_0_5$Prediction,
               res_PPC_id_0_8$Prediction,
               res_PPC_spt_0_5$Prediction,
               res_PPC_spt_0_8$Prediction,
               res_PPC_sps_0_5$Prediction,
               res_PPC_sps_0_8$Prediction)
}

tot_run          = length(vec_data)
number_pred_sing = length(vec_data[1][[1]]$Prediction)
...
for (i in 1:tot_run) {
  ...
  k_used[i]       = vec_data[[i]]$N_PPCs 
  exp_pow_used[i] = vec_data[[i]]$Exp_Pow[k_used[i]] 
}
