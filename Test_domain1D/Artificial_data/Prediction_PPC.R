...
#file for saving results
{
  ...
  file_saving_PPC_id_0_5  = "/prediction_PPC_id_0_5.Rdata"
  file_saving_PPC_id_0_8  = "/prediction_PPC_id_0_8.Rdata"
  file_saving_PPC_spt_0_5 = "/prediction_PPC_spt_0_5.Rdata"
  file_saving_PPC_spt_0_8 = "/prediction_PPC_spt_0_8.Rdata"
  file_saving_PPC_sps_0_5 = "/prediction_PPC_sps_0_5.Rdata"
...
#storing prediction
{
  prediction_PPC_gau_0_5 <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_gau_0_8 <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_id_0_5  <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_id_0_8  <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_spt_0_5 <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_spt_0_8 <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_sps_0_5 <- lapply((1):N-1,function(x) NULL)
  prediction_PPC_sps_0_8 <- lapply((1):N-1,function(x) NULL)
}

#storing errors
{
  err_PPC_gau_0_5_en <- numeric(N)     
  err_PPC_gau_0_5_rn <- numeric(N)
  err_PPC_id_0_5_en  <- numeric(N)     
  err_PPC_id_0_5_rn  <- numeric(N)
  err_PPC_spt_0_5_en <- numeric(N)     
  err_PPC_spt_0_5_rn <- numeric(N)
  err_PPC_sps_0_5_en <- numeric(N)     
  err_PPC_sps_0_5_rn <- numeric(N)
  err_PPC_gau_0_8_en <- numeric(N)     
  err_PPC_gau_0_8_rn <- numeric(N)
  err_PPC_id_0_8_en  <- numeric(N)     
  err_PPC_id_0_8_rn  <- numeric(N)
  err_PPC_spt_0_8_en <- numeric(N)     
  err_PPC_spt_0_8_rn <- numeric(N)
  err_PPC_sps_0_8_en <- numeric(N)     
  err_PPC_sps_0_8_rn <- numeric(N)
}
...
#save results
if(save_res){
  res_PPC_gau_0_5 = list(Prediction = prediction_PPC_gau_0_5, En = err_PPC_gau_0_5_en, Rn = err_PPC_gau_0_5_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_gau_0_5)
  save(res_PPC_gau_0_5, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_gau_0_8 = list(Prediction = prediction_PPC_gau_0_8, En = err_PPC_gau_0_8_en, Rn = err_PPC_gau_0_8_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_gau_0_8)
  save(res_PPC_gau_0_8, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_id_0_5 = list(Prediction = prediction_PPC_id_0_5, En = err_PPC_id_0_5_en, Rn = err_PPC_id_0_5_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_id_0_5)
  save(res_PPC_id_0_5, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_id_0_8 = list(Prediction = prediction_PPC_id_0_8, En = err_PPC_id_0_8_en, Rn = err_PPC_id_0_8_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_id_0_8)
  save(res_PPC_id_0_8, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_spt_0_5 = list(Prediction = prediction_PPC_spt_0_5, En = err_PPC_spt_0_5_en, Rn = err_PPC_spt_0_5_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_spt_0_5)
  save(res_PPC_spt_0_5, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_spt_0_8 = list(Prediction = prediction_PPC_spt_0_8, En = err_PPC_spt_0_8_en, Rn = err_PPC_spt_0_8_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_spt_0_8)
  save(res_PPC_spt_0_8, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_sps_0_5 = list(Prediction = prediction_PPC_sps_0_5, En = err_PPC_sps_0_5_en, Rn = err_PPC_sps_0_5_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_sps_0_5)
  save(res_PPC_sps_0_5, file = file_saving)
}
...
#save results
if(save_res){
  res_PPC_sps_0_8 = list(Prediction = prediction_PPC_sps_0_8, En = err_PPC_sps_0_8_en, Rn = err_PPC_sps_0_8_rn)
  file_saving = paste0(path_stor_res,file_saving_PPC_sps_0_8)
  save(res_PPC_sps_0_8, file = file_saving)
}
