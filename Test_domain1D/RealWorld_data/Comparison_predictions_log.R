...
#############################################################################################################
### Overlapping predicted log-curves plot, for each one of the predictors, for each of the days predicted ###
#############################################################################################################
...
path_stor_res = paste0(paste0(dir_res,"/results_plot_predictions_log")) 
